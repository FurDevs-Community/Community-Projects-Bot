...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if(confirm){
      ...
      await message.reply({content: "Application approved! closing ticket."})
      ...
      await logit.send({content: `Application of <@${repuser}> for their project entitled "${mate[0]}" has been approved by <@${message.author.id}>`})
    }
  }
}