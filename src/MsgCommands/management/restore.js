...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (args.length < 2) return message.reply({ content: "Specify the project to restore and reason, please! (missing args: `channel`, `reason`" })
    let target = args[0]
    ...
    if (check) {
      ...
      if (inserver) {
        ...
        const usurekigu = new EmbedBuilder()
          ...
          .setTitle("Project Restoration - Are you sure?")
          .setDescription(`Do you wish to restore this project?`)
          .setTimestamp()
        ...
        const Log = new EmbedBuilder()
          ...
          .addFields([
            ...
            { name: "Action Type:", value: "**Project Restoration**" },
          ...
          collector.on('collect', async i => {
            if (i) {
              ...
              if (i.customId == 'bignono') {
                ...
                i.editReply({ content: `Project will be restored shortly. Welcome back!`, embeds: [], components: [] })
                ...
                await inserver.permissionOverwrites.edit('926013442849116170', {
                  ViewChannel: true
                })
              }
            }
